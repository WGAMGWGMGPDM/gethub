...
public class MailUtil implements Runnable {
    ...
    private static final String MAIL_HOST_PORT ="mail.smtp.port";//发送邮件的端口
    private static final String MAIL_HOST_PORT_VALUE ="465"; //发送邮件的端口号
    ...
    //邮件编辑信息(仅需写上自己的)
    private static final String MAIL_FROM ="1072492799@qq.com";//邮件发送人
    private static final String MAIL_FROM_PASSWORD ="eatfltxjezaubbic";//邮件发送人授权码
    private static final String MAIL_SUBJECT_REGISTER ="Gethub用户激活链接";//邮件主题(注册链接)http://127.0.0.1:8080/registe/activate?cdkey=
    private static final String MAIL_SUBJECT_VERIFY_CODE ="Gethub验证码";//邮件主题(邮箱验证码)xxxx【邮箱验证码】
    private static final String MAIL_ORGANIZATION ="Gethub";//邮件组织
    private static final String MAIL_WEBSITE ="http://www.gethub.ren/main.html";//组织主页
    private static final String MAIL_ORGANIZATION_LOGO ="http://101.200.130.83/group1/M00/00/00/rBEwVV5vSCaAL9e1AAFTVZsdEbk158.png";//网站logo
    private static final String MAIL_ORGANIZATION_QRCODE ="http://101.200.130.83/group1/M00/00/00/rBEwVV5vTWmATcGvAABsH8dykD8571.jpg";//网站二维码图片
        ...
        if(sendType=="activate"){
            sendEmail(MAIL_FROM,
                    ...
                    prettyLayout(MAIL_ORGANIZATION,MAIL_WEBSITE,
                            ...
                            prettyRegisterLayout("2小时",MAIL_ORGANIZATION,"http://www.gethub.ren/page/visitor/login/activate.html?cdkey="+code),
                            MAIL_ORGANIZATION_QRCODE),
                    MAIL_FROM_PASSWORD);
        }else if(sendType=="validity") {
            sendEmail(MAIL_FROM,
                    email,
                    MAIL_SUBJECT_VERIFY_CODE,
                    prettyLayout(MAIL_ORGANIZATION,MAIL_WEBSITE,
                            MAIL_ORGANIZATION_LOGO,
                            prettyQrCodeLayout("5分钟",code),
                            MAIL_ORGANIZATION_QRCODE),
                    MAIL_FROM_PASSWORD);
        }
    }
    ...
    public static void sendEmail(String from,String to,String subject,String content,String password) throws Exception{
        ...
        props.setProperty(MAIL_HOST_PORT,MAIL_HOST_PORT_VALUE);
...
//        message.setText("<h1>hello</h1>");//纯文本
    ...
    private static String prettyLayout(String websiteName,String principal,String principalImage,String business,String...qrCode){
        return mailHead(websiteName,principal,principalImage,"150px","150px")+
                business +
