...
public class Mail {
    ...
    private static final String MAIL_SUBJECT_VERIFY_CODE ="Gethub注册激活";//邮件主题(邮箱验证码)xxxx【邮箱验证码】
    private static final String MAIL_ORGANIZATION ="Gethub";//邮件组织
    private static final String MAIL_WEBSITE ="http://127.0.0.1:8848/gethub/login.html";//组织主页
    ...
    public static void main(String[] args) throws Exception{
        sendEmail(MAIL_FROM,
                ...
                prettyLayout(MAIL_ORGANIZATION,MAIL_WEBSITE,
                        ...
                        prettyRegisterLayout("2小时",MAIL_ORGANIZATION,"http://127.0.0.1:8080/registe/activate?cdkey=99aa9802e5de46138a10d0a6d4732c75"),
